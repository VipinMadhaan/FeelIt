...
* :(fa-solid fa-chart-bar fa-fw): 支持 **[Fathom Analytics](https://usefathom.com/)**
...
* :(fa-solid fa-list-alt fa-fw): 易用和自动展开的**文章目录**
* :(fa-solid fa-language fa-fw): 支持**多语言**和国际化
* :(fa-brands fa-css3-alt fa-fw): 美观的 **CSS 动画**

#### 社交和评论系统

* :(fa-solid fa-user fa-fw): 支持 **[Gravatar](https://gravatar.com)** 头像
* :(fa-solid fa-user-circle fa-fw): 支持本地**头像**
* :(fa-solid fa-id-card fa-fw): 支持多达 **64** 种社交链接
* :(fa-solid fa-share-square fa-fw): 支持多达 **28** 种网站分享
* :(fa-solid fa-comment fa-fw): 支持 **[Disqus](https://disqus.com)** 评论系统
* :(fa-solid fa-comment-dots fa-fw): 支持 **[Gitalk](https://github.com/gitalk/gitalk)** 评论系统
* :(fa-solid fa-comment-alt fa-fw): 支持 **[Valine](https://valine.js.org/)** 评论系统
* :(fa-solid fa-comments fa-fw): 支持 **[Vssue](https://vssue.js.org/)** 评论系统
* :(fa-solid fa-comments fa-fw): 支持 **[Facebook](https://developers.facebook.com/docs/plugins/comments/) 评论**系统
...
* :(fa-solid fa-comment-alt fa-fw): 支持 **[Utterances](https://utteranc.es/)** 评论系统

#### 扩展功能

* :(fa-solid fa-search fa-fw): 支持基于 [Lunr.js](https://lunrjs.com/) 或 [algolia](https://www.algolia.com/) 的**搜索**
* :(fa-solid fa-grin-tongue-wink fa-fw): 支持 **Twemoji**
* :(fa-solid fa-code fa-fw): 支持**代码高亮**
* :(fa-solid fa-copy fa-fw): 一键**复制代码**到剪贴板
* :(fa-solid fa-images fa-fw): 支持基于 [lightgallery.js](https://github.com/sachinchoolur/lightgallery.js) 的**图片画廊**
* :(fa-brands fa-font-awesome fa-fw): 支持 **[Font Awesome](https://fontawesome.com/) 图标**的扩展 Markdown 语法
* :(fa-solid fa-sticky-note fa-fw): 支持**上标注释**的扩展 Markdown 语法
...
* :(fa-solid fa-bell fa-fw): 支持多种**注释**的 shortcode
